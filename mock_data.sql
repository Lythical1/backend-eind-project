...
VALUES
  ...
  ('Company A', 'Software Development', 'Full-time', 'City A', 40, 25.00, 'Lorem ipsum...', 1),
  ('Company B', 'Data Science', 'Part-time', 'City B', 20, 30.00, 'Consectetur adipiscing elit...', 1),
  ('Company C', 'Web Development', 'Contract', 'City C', 30, 22.00, 'Duis aute irure dolor...', 1);